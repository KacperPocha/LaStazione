      ...
      <div className="sm:text-[25px] md:text-[35px] l:text-[35px] xl:text-[40px] font-semibold leading-[55px] flex justify-center text-center mt-24 mb-12 ml-2 mr-2">
        <div>
          ...
          <div className="text-white mt-8 flex sm:flex-col sm:items-center md:flex-row md:ml-6 l:ml-20">
            <a
              className="sm:text-[20px] md:text-[32px] font-semibold bg-[#343434] sm:pt-2 sm:pb-2 sm:pl-11 sm:pr-11 md:pt-4 md:pb-4 md:pl-6 md:pr-6 md:mr-12 l:pt-4 l:pb-4 l:pl-6 l:pr-6 l:mr-2 xl:pt-4 xl:pl-6 xl:pr-6 xl:mr-2 xl:ml-8 rounded-full " href="tel:572172272"
            >
              +48 572 172 272
            </a>
            <div
